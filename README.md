<h1 align="center">📄 Resume & Professional Portfolio</h1>

<h3 align="center">
  AI & Machine Learning Engineer | Software Engineer | Data Analyst
</h3>

<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com/?lines=AI%20%26%20ML%20Engineer;Software%20Engineer;Samsung%20Fellow%20'26;Ex-IEEE%20Chairperson&center=true&width=600&height=50">
</p>
...
| :--- | :--- |
| **AI, ML & GenAI** | Large Language Models (LLMs), AI Agents (MCP), Multi-Agent Systems, Neural Networks, Computer Vision, NLP, Deep Learning Metrics |
| **Programming & Backend** | Python, SQL, JavaScript, C, Django, React, HTML5/CSS3, REST API Endpoints, System Design, Advanced DSA |
| **Data, Analytics & GIS** | Tableau, Power BI, QGIS, OpenVSP (Aircraft Modeling), Statsmodels, Pandas, NumPy, Time Series Forecasting, Class Imbalance Resolution |
| **Cloud & DevOps** | Google Cloud Platform (GCP), Microsoft Azure, GitHub, VS Code, Microcontroller Telemetry Integration |

---

## 🚀 Featured Technical Projects

**Smart Bin: Distributed Full-Stack IoT Platform** 
  * Engineered a fully responsive Django web application to aggregate real-time hardware telemetry streams directly into structural database tables.
  * Automated waste segregation utilizing Arduino microcontrollers, humidity/ultrasonic sensors, and servo motors to instantly separate wet and dry waste.
* **Aircraft Parametric Modeling (OpenVSP)** 
  * Developed parametric 3D modeling of a NASA-variant Cessna 210 aircraft using geometric parameter interpretation.
...
<p align="center">
  <i>"Leveraging AI, robust software engineering, and geospatial analytics to build resilient, real-world systems."</i>
</p>
